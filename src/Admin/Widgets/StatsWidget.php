		...
		<div class="cfr2-stats-widget">
			<div class="cfr2-stats-summary">
				<div class="cfr2-stat-item cfr2-stat-single">
					...
					<span class="cfr2-stat-label"><?php esc_html_e( 'Requests This Month', 'thachpham-offload-cdn-cloudflare-r2' ); ?></span>
				</div>
			</div>

			<?php if ( ! $is_deployed ) : ?>
				<div class="cfr2-stats-notice">
					<p><?php esc_html_e( 'Deploy the Worker to see analytics.', 'thachpham-offload-cdn-cloudflare-r2' ); ?></p>
				</div>
			<?php endif; ?>
					...
					<p>
						...
						echo wp_kses_post(
							sprintf(
								...
								__( 'View detailed analytics in your <a href="%s" target="_blank" rel="noopener">Cloudflare Dashboard</a>', 'thachpham-offload-cdn-cloudflare-r2' ),

...
class AdminMenu implements HookableInterface {
	 ...
	 * Admin menu slug.
	 */
	private const MENU_SLUG = 'thachpham-offload-cdn-cloudflare-r2';
	...
	public function add_menu_page(): void {
		add_menu_page(
			__( 'ThachPham Offload & CDN for Cloudflare R2 Settings', 'thachpham-offload-cdn-cloudflare-r2' ),
			__( 'ThachPham Offload & CDN for Cloudflare R2', 'thachpham-offload-cdn-cloudflare-r2' ),
			'manage_options',
			self::MENU_SLUG,
